...
/datum/preferences
	proc/ShowChoices(mob/user)
		...
		//		dat += "Skin pattern: <a href='byond://?src=\ref[user];preference=skin_style;task=input'>Adjust</a><br>"
				...
				if((species in list("Unathi", "Tajaran", "Skrell", "Slime People", "Machine")) || body_accessory_by_species[species] || check_rights(R_ADMIN, 0, user)) //admins can always fuck with this, because they are admins
		...
		switch(href_list["task"])
			if("random")
				switch(href_list["preference"])
					...
					if("s_color")
						if(species in list("Unathi", "Tajaran", "Skrell", "Slime People", "Wyrn", "Machine"))
							r_skin = rand(0,255)
							g_skin = rand(0,255)
							b_skin = rand(0,255)
					if("bag")
...
*/
					...
					if("skin")
						if((species in list("Unathi", "Tajaran", "Skrell", "Slime People", "Machine")) || body_accessory_by_species[species] || check_rights(R_ADMIN, 0, user))
