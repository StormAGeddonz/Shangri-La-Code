				...
				switch(href_list["KarmaBuy2"])
					if("1")
						if(karma <15)
							...
							src.DB_species_unlock("Machine",40)
							return
					if("2")
						if(karma <30)
							usr << "You do not have enough karma!"
							...
							src.DB_species_unlock("Kidan",40)
							return
					if("3")
						if(karma <30)
							usr << "You do not have enough karma!"
					...
					if("5")
						if(karma <45)
							...
							src.DB_species_unlock("Slime People",40)
							return
					if("6")
						if(karma <100)
							usr << "You do not have enough karma!"
					...
					if("7")
						if(karma <200)
							...
							src.DB_species_unlock("Tajaran",200)
							return
					if("8")
						if(karma <200)
							usr << "You do not have enough karma!"
							...
							src.DB_species_unlock("Unathi",200)
							return
