...
/datum/sprite_accessory/socks
	icon = 'icons/mob/underwear.dmi'
	species_allowed = list("Human","Unathi","Diona","Grey","Machine","Tajaran","Slime People","Skellington")

/datum/sprite_accessory/socks/nude
	name = "Nude"
	icon_state = null
	gender = NEUTER
	species_allowed = list("Human","Unathi","Diona","Grey","Machine","Tajaran","Slime People","Skellington","Vox")
