...
/client/proc/karmashopmenu()
	...
	switch(karma_tab)
		...
		if (1) // Species Unlocks
			dat += {"
			<a href='?src=\ref[src];karmashop=shop;KarmaBuy2=1'>Unlock Machine People -- 100KP</a><br>
			<a href='?src=\ref[src];karmashop=shop;KarmaBuy2=2'>Unlock Kidan -- 100KP</a><br>
			<a href='?src=\ref[src];karmashop=shop;KarmaBuy2=3'>Unlock Grey -- 100KP</a><br>
			<a href='?src=\ref[src];karmashop=shop;KarmaBuy2=4'>Unlock Vox -- 100KP</a><br>
			<a href='?src=\ref[src];karmashop=shop;KarmaBuy2=5'>Unlock Slime People -- 100KP</a><br>
			<a href='?src=\ref[src];karmashop=shop;KarmaBuy2=6'>Unlock Plasmaman -- 100KP</a><br>
			<a href='?src=\ref[src];karmashop=shop;KarmaBuy2=7'>Unlock Tajaran -- 200KP</a><br>
			<a href='?src=\ref[src];karmashop=shop;KarmaBuy2=7'>Unlock Unathi -- 200KP</a><br>
			"}
